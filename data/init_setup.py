...
def create_log_files(data_dir, results_dir, log_file):
    ...
    '''
    if not os.path.exists(os.path.join(data_dir, log_file)):
        with open(os.path.join(data_dir, log_file), 'w') as f:
            f.close()
...
def generate_dataset_csv(data_dir, data_file, file_ext, log_dir):
    '''
...
if __name__ == "__main__":
    ...
    generate_dataset_csv(args.data_dir, args.data_file, args.file_ext, args.results_dir)
